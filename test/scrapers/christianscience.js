...
let ChristianScience = require('../../scrapers/christianscience')
let expect = require('chai').expect
var obj, dataObj

describe('ChristianScience scraper', function() {

    before(function(done) {
        new ChristianScience().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of ChristianScience', function() {
        expect(obj).to.be.an.instanceof(ChristianScience);
    })
    ...
    describe('ChristianScience stories object', function() {
        before(function() {
