...
let FoxNews = require('../../scrapers/foxnews')
let expect = require('chai').expect
var obj, dataObj

describe('FoxNews scraper', function() {

    before(function(done) {
        new FoxNews().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of FoxNews', function() {
        expect(obj).to.be.an.instanceof(FoxNews);
    })
    ...
    describe('FoxNews stories object', function() {
        before(function() {
