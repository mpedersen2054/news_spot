...
let USNews = require('../../scrapers/usnews')
let expect = require('chai').expect
var obj, dataObj

describe('USNews scraper', function() {

    before(function(done) {
        new USNews().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of USNews', function() {
        expect(obj).to.be.an.instanceof(USNews);
    })
    ...
    describe('USNews stories object', function() {
        before(function() {
