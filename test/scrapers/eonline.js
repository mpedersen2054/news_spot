...
let EOnline = require('../../scrapers/eonline')
let expect = require('chai').expect
var obj, dataObj

describe('EOnline scraper', function() {

    before(function(done) {
        new EOnline().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of EOnline', function() {
        expect(obj).to.be.an.instanceof(EOnline);
    })
    ...
    describe('EOnline stories object', function() {
        before(function() {
