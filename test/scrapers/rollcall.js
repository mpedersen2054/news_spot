...
let RollCall = require('../../scrapers/rollcall')
...
describe('RollCall scraper', function() {
    ...
    before(function(done) {
        new RollCall().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of RollCall', function() {
        expect(obj).to.be.an.instanceof(RollCall);
    })
