...
let Atlanticnews = require('../../scrapers/atlanticnews')
let expect = require('chai').expect
var obj, dataObj

describe('Atlanticnews scraper', function() {

    before(function(done) {
        new Atlanticnews().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of Atlanticnews', function() {
        expect(obj).to.be.an.instanceof(Atlanticnews);
    })
    ...
    describe('Atlanticnews stories object', function() {
        before(function() {
