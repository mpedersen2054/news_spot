...
let LATimes = require('../../scrapers/latimes')
let expect = require('chai').expect
var obj, dataObj

describe('LATimes scraper', function() {

    before(function(done) {
        new LATimes().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of LATimes', function() {
        expect(obj).to.be.an.instanceof(LATimes);
    })
    ...
    describe('LATimes stories object', function() {
        before(function() {
