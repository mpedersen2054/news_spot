...
let CNBCNews = require('../../scrapers/cnbcnews')
let expect = require('chai').expect
var obj, dataObj

describe('CNBCNews scraper', function() {

    before(function(done) {
        new CNBCNews().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of CNBCNews', function() {
        expect(obj).to.be.an.instanceof(CNBCNews);
    })
    ...
    describe('CNBCNews stories object', function() {
        before(function() {
