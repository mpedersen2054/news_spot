...
let WashingtonPost = require('../../scrapers/washingtonpost')
...
describe('WashingtonPost scraper', function() {
    ...
    before(function(done) {
        new WashingtonPost().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of WashingtonPost', function() {
        expect(obj).to.be.an.instanceof(WashingtonPost);
    })
