...
let Variety = require('../../scrapers/variety')
let expect = require('chai').expect
var obj, dataObj

describe('Variety scraper', function() {

    before(function(done) {
        new Variety().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of Variety', function() {
        expect(obj).to.be.an.instanceof(Variety);
    })
    ...
    describe('Variety stories object', function() {
        before(function() {
