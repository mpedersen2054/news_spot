...
let NYPost = require('../../scrapers/nypost')
let expect = require('chai').expect
var obj, dataObj

describe('NYPost scraper', function() {

    before(function(done) {
        new NYPost().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of NYPost', function() {
        expect(obj).to.be.an.instanceof(NYPost);
    })
    ...
    describe('NYPost stories object', function() {
        before(function() {
