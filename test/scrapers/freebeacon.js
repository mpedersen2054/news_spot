...
let FreeBeacon = require('../../scrapers/freebeacon')
let expect = require('chai').expect
var obj, dataObj

describe('FreeBeacon scraper', function() {

    before(function(done) {
        new FreeBeacon().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of FreeBeacon', function() {
        expect(obj).to.be.an.instanceof(FreeBeacon);
    })
    ...
    describe('FreeBeacon stories object', function() {
        before(function() {
