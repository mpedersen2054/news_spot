...
let Politico = require('../../scrapers/politico')
let expect = require('chai').expect
var obj, dataObj

describe('Politico scraper', function() {

    before(function(done) {
        new Politico().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of Politico', function() {
        expect(obj).to.be.an.instanceof(Politico);
    })
    ...
    describe('Politico stories object', function() {
        before(function() {
