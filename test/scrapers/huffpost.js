...
let HuffPost = require('../../scrapers/huffpost')
let expect = require('chai').expect
var obj, dataObj

describe('HuffPost scraper', function() {

    before(function(done) {
        new HuffPost().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of HuffPost', function() {
        expect(obj).to.be.an.instanceof(HuffPost);
    })
    ...
    describe('HuffPost stories object', function() {
        before(function() {
