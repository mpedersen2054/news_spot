...
let WashingtonTimes = require('../../scrapers/washingtontimes')
let expect = require('chai').expect
var obj, dataObj

describe('WashingtonTimes scraper', function() {

    before(function(done) {
        new WashingtonTimes().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of WashingtonTimes', function() {
        expect(obj).to.be.an.instanceof(WashingtonTimes);
    })
    ...
    describe('WashingtonTimes stories object', function() {
        before(function() {
