...
let France24 = require('../../scrapers/france24')
...
describe('France24 scraper', function() {
    ...
    before(function(done) {
        new France24().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of France24', function() {
        expect(obj).to.be.an.instanceof(France24);
    })
