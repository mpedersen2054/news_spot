...
let USAToday = require('../../scrapers/usatoday')
let expect = require('chai').expect
var obj, dataObj

describe('USAToday scraper', function() {

    before(function(done) {
        new USAToday().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of USAToday', function() {
        expect(obj).to.be.an.instanceof(USAToday);
    })
    ...
    describe('USAToday stories object', function() {
        before(function() {
