...
let CBSNews = require('../../scrapers/cbsnews')
let expect = require('chai').expect
var obj, dataObj

describe('CBSNews scraper', function() {

    before(function(done) {
        new CBSNews().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of CBSNews', function() {
        expect(obj).to.be.an.instanceof(CBSNews);
    })
    ...
    describe('CBSNews stories object', function() {
        before(function() {
