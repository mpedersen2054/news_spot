...
let RadarOnline = require('../../scrapers/radaronline')
let expect = require('chai').expect
var obj, dataObj

describe('RadarOnline scraper', function() {

    before(function(done) {
        new RadarOnline().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of RadarOnline', function() {
        expect(obj).to.be.an.instanceof(RadarOnline);
    })
    ...
    describe('RadarOnline stories object', function() {
        before(function() {
