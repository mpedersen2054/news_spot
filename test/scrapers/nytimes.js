...
let NYTimes = require('../../scrapers/nytimes')
let expect = require('chai').expect
var obj, dataObj

describe('NYTimes scraper', function() {

    before(function(done) {
        new NYTimes().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of NYTimes', function() {
        expect(obj).to.be.an.instanceof(NYTimes);
    })
    ...
    describe('NYTimes stories object', function() {
        before(function() {
