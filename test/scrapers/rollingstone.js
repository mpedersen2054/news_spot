...
let RollingStone = require('../../scrapers/rollingstone')
let expect = require('chai').expect
var obj, dataObj

describe('RollingStone scraper', function() {

    before(function(done) {
        new RollingStone().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of RollingStone', function() {
        expect(obj).to.be.an.instanceof(RollingStone);
    })
    ...
    describe('RollingStone stories object', function() {
        before(function() {
