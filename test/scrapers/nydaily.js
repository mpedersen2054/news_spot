...
let NYDaily = require('../../scrapers/nydaily')
let expect = require('chai').expect
var obj, dataObj

describe('NYDaily scraper', function() {

    before(function(done) {
        new NYDaily().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of NYDaily', function() {
        expect(obj).to.be.an.instanceof(NYDaily);
    })
    ...
    describe('NYDaily stories object', function() {
        before(function() {
