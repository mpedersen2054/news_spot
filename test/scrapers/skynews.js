...
let SkyNews = require('../../scrapers/skynews')
...
describe('SkyNews scraper', function() {
    ...
    before(function(done) {
        new SkyNews().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of SkyNews', function() {
        expect(obj).to.be.an.instanceof(SkyNews);
    })
