...
let Times = require('../../scrapers/times')
let expect = require('chai').expect
var obj, dataObj

describe('Times scraper', function() {

    before(function(done) {
        new Times().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of Times', function() {
        expect(obj).to.be.an.instanceof(Times);
    })
    ...
    describe('Times stories object', function() {
        before(function() {
