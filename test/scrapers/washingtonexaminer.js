...
let WashingtonExaminer = require('../../scrapers/washingtonexaminer')
let expect = require('chai').expect
var obj, dataObj

describe('WashingtonExaminer scraper', function() {

    before(function(done) {
        new WashingtonExaminer().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of WashingtonExaminer', function() {
        expect(obj).to.be.an.instanceof(WashingtonExaminer);
    })
    ...
    describe('WashingtonExaminer stories object', function() {
        before(function() {
