...
let TMZ = require('../../scrapers/tmz')
let expect = require('chai').expect
var obj, dataObj

describe('TMZ scraper', function() {

    before(function(done) {
        new TMZ().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of TMZ', function() {
        expect(obj).to.be.an.instanceof(TMZ);
    })
    ...
    describe('TMZ stories object', function() {
        before(function() {
