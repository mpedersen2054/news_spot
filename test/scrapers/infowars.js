...
let Infowars = require('../../scrapers/infowars')
let expect = require('chai').expect
var obj, dataObj

describe('Infowars scraper', function() {

    before(function(done) {
        new Infowars().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of Infowars', function() {
        expect(obj).to.be.an.instanceof(Infowars);
    })
    ...
    describe('Infowars stories object', function() {
        before(function() {
