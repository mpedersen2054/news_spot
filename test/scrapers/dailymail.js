...
let DailyMail = require('../../scrapers/dailymail')
let expect = require('chai').expect
var obj, dataObj

describe('DailyMail scraper', function() {

    before(function(done) {
        new DailyMail().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of DailyMail', function() {
        expect(obj).to.be.an.instanceof(DailyMail);
    })
    ...
    describe('DailyMail stories object', function() {
        before(function() {
