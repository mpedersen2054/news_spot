...
let ZeroHedge = require('../../scrapers/zerohedge')
...
describe('ZeroHedge scraper', function() {
    ...
    before(function(done) {
        new ZeroHedge().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of ZeroHedge', function() {
        expect(obj).to.be.an.instanceof(ZeroHedge);
    })
