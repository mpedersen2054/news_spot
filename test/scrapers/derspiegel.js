...
let DerSpiegel = require('../../scrapers/derspiegel')
...
describe('DerSpiegel scraper', function() {
    ...
    before(function(done) {
        new DerSpiegel().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of DerSpiegel', function() {
        expect(obj).to.be.an.instanceof(DerSpiegel);
    })
