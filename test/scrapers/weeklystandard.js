...
let WeeklyStandard = require('../../scrapers/weeklystandard')
let expect = require('chai').expect
var obj, dataObj

describe('WeeklyStandard scraper', function() {

    before(function(done) {
        new WeeklyStandard().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of WeeklyStandard', function() {
        expect(obj).to.be.an.instanceof(WeeklyStandard);
    })
    ...
    describe('WeeklyStandard stories object', function() {
        before(function() {
