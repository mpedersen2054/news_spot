...
let TheHill = require('../../scrapers/thehill')
let expect = require('chai').expect
var obj, dataObj

describe('TheHill scraper', function() {

    before(function(done) {
        new TheHill().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of TheHill', function() {
        expect(obj).to.be.an.instanceof(TheHill);
    })
    ...
    describe('TheHill stories object', function() {
        before(function() {
