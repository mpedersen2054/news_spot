...
let ChicagoSun = require('../../scrapers/chicagosun')
let expect = require('chai').expect
var obj, dataObj

describe('ChicagoSun scraper', function() {

    before(function(done) {
        new ChicagoSun().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of ChicagoSun', function() {
        expect(obj).to.be.an.instanceof(ChicagoSun);
    })
    ...
    describe('ChicagoSun stories object', function() {
        before(function() {
