...
let CNNNews = require('../../scrapers/cnnnews')
let expect = require('chai').expect
var obj, dataObj

describe('CNNNews scraper', function() {

    before(function(done) {
        new CNNNews().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of CNNNews', function() {
        expect(obj).to.be.an.instanceof(CNNNews);
    })
    ...
    describe('CNNNews stories object', function() {
        before(function() {
