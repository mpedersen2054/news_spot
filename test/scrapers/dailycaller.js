...
let DailyCaller = require('../../scrapers/dailycaller')
let expect = require('chai').expect
var obj, dataObj

describe('DailyCaller scraper', function() {

    before(function(done) {
        new DailyCaller().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of DailyCaller', function() {
        expect(obj).to.be.an.instanceof(DailyCaller);
    })
    ...
    describe('DailyCaller stories object', function() {
        before(function() {
