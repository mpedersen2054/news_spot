...
let TheIndependent = require('../../scrapers/theindependent')
let expect = require('chai').expect
var obj, dataObj

describe('TheIndependent scraper', function() {

    before(function(done) {
        new TheIndependent().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of TheIndependent', function() {
        expect(obj).to.be.an.instanceof(TheIndependent);
    })
    ...
    describe('TheIndependent stories object', function() {
        before(function() {
