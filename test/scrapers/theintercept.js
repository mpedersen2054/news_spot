...
let TheIntercept = require('../../scrapers/theintercept')
let expect = require('chai').expect
var obj, dataObj

describe('TheIntercept scraper', function() {

    before(function(done) {
        new TheIntercept().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of TheIntercept', function() {
        expect(obj).to.be.an.instanceof(TheIntercept);
    })
    ...
    describe('TheIntercept stories object', function() {
        before(function() {
