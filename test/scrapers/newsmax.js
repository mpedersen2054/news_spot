...
let Newsmax = require('../../scrapers/newsmax')
...
describe('Newsmax scraper', function() {
    ...
    before(function(done) {
        new Newsmax().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of Newsmax', function() {
        expect(obj).to.be.an.instanceof(Newsmax);
    })
