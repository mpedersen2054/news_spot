...
let ExpressNews = require('../../scrapers/expressnews')
let expect = require('chai').expect
var obj, dataObj

describe('ExpressNews scraper', function() {

    before(function(done) {
        new ExpressNews().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of ExpressNews', function() {
        expect(obj).to.be.an.instanceof(ExpressNews);
    })
    ...
    describe('ExpressNews stories object', function() {
        before(function() {
