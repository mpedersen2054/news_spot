...
let TheEconomist = require('../../scrapers/theeconomist')
let expect = require('chai').expect
var obj, dataObj

describe('TheEconomist scraper', function() {

    before(function(done) {
        new TheEconomist().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of TheEconomist', function() {
        expect(obj).to.be.an.instanceof(TheEconomist);
    })
    ...
    describe('TheEconomist stories object', function() {
        before(function() {
