...
let RealClearPolitics = require('../../scrapers/realclearpolitics')
let expect = require('chai').expect
var obj, dataObj

describe('RealClearPolitics scraper', function() {

    before(function(done) {
        new RealClearPolitics().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of RealClearPolitics', function() {
        expect(obj).to.be.an.instanceof(RealClearPolitics);
    })
    ...
    describe('RealClearPolitics stories object', function() {
        before(function() {
