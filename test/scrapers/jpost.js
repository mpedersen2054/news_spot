...
let JPost = require('../../scrapers/jpost')
let expect = require('chai').expect
var obj, dataObj

describe('JPost scraper', function() {

    before(function(done) {
        new JPost().init(function(retObj) {
            obj = retObj
            done()
        })
    })

    it('should be an instance of JPost', function() {
        expect(obj).to.be.an.instanceof(JPost);
    })
    ...
    describe('JPost stories object', function() {
        before(function() {
